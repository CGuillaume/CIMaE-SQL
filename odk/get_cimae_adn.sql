...
-- Tache cron - Exécution 01h10 et 13h10 = 10 1,13 * * * psql -h localhost -p 7432 -U postgres -f /home/gcostes/plpyodk/get_cimae_adn.sql -d cimae
...
FROM odk_central."cimae-adn_last_submission_date";