...
CREATE MATERIALIZED VIEW IF NOT EXISTS odk_central."cimae-public_last_submission_date" AS 
	SELECT max("submissionDate")::text AS last_submission_date
	FROM odk_central."cimae-public_submissions_data";

REFRESH MATERIALIZED VIEW odk_central."cimae-public_last_submission_date";

SELECT plpyodk.odk_central_to_pg(
	16,		-- the project id, 
	'cimae-public'::text,		-- form ID
...
FROM odk_central."cimae-public_last_submission_date";